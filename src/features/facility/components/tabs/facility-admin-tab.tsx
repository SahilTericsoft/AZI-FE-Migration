...
/** Admin Details = the facility's admin user (`adminDetails`, populated by view). */
export default function FacilityAdminTab({ facility }: { facility: Facility }) {
  const admin = (facility.adminDetails ?? undefined) as
